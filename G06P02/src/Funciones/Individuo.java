...
public abstract class Individuo {
	...
	protected final static int _posMadrid = 27;
	
	protected final static int[][] _DIST = {
			{},
			{171},
			{369,	294},
			{366,	537,	633},
			...
			{473,	482,	219,	644,	436,	997,	939,	781,	506,	265,	713,	388,	187,	1153,	615,	1097,	129,	602,	313,	941,	209,	877,	1009,	880,	1055},
			{150,	75,		219,	516,	675,	590,	796,	638,	654,	613,	306,	357,	444,	1010,	292,	690,	278,	459,	628,	611,	340,	734,	583,	694,	912,	407},
			{251,	422,	563,	115,	401,	621,	395,	237,	297,	663,	417,	190,	400,	609,	167,	721,	434,	58,		632,	397,	335,	333,	465,	336,	551,	544,	401}
			};
	...
	public void setCrom(int i, int valor) {
		 cromosoma[i] = valor;
	}
}
